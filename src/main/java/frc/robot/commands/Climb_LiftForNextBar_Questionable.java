...
public class Climb_LiftForNextBar_Questionable extends CommandBase {
   ...
   * @param liftSubsystem
   */
  public Climb_LiftForNextBar_Questionable(ClimbAngle angleSubsystem, ClimbHook hookSubsystem, ClimbLift liftSubsystem) {
    ...
    switch(climbStep) {
      ...
      case 12:  // winch out while avoiding the bar
        ...
        if (liftSubsystem.getLeftEncoderDistance() > 32.8 &&
          ...
          if ((liftSubsystem.getLeftEncoderDistance() > 22 && liftSubsystem.getLeftEncoderDistance() < 26) &&
              (liftSubsystem.getRightEncoderDistance() > 22 && liftSubsystem.getRightEncoderDistance() < 26)) {
          ...
          if ((liftSubsystem.getLeftEncoderDistance() > 10 && liftSubsystem.getLeftEncoderDistance() < 15) &&
