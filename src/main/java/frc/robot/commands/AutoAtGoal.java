...
public class AutoAtGoal extends SequentialCommandGroup {
  public AutoAtGoal(DriveBase driveBase, Conveyor conveyor, Intake intake) {
    addCommands(

      // shoot preloaded ball for five secs
      new ParallelDeadlineGroup(new WaitCommand(5), new ShootBall(conveyor)),
      ...
      new ParallelDeadlineGroup(
        ...
        new SequentialCommandGroup(
          new AutoDriveDistance(driveBase, -119),  // I think this distance is correct.
      ...
      new AutoDriveDistance(driveBase, 120), // TODO: check distance from ball to goal
