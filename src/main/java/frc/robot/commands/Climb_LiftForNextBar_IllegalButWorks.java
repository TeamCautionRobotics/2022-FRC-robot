...
public class Climb_LiftForNextBar_IllegalButWorks extends CommandBase {
   ...
   * @param liftSubsystem
   */
  public Climb_LiftForNextBar_IllegalButWorks(ClimbAngle angleSubsystem, ClimbHook hookSubsystem, ClimbLift liftSubsystem) {
